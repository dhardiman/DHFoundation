...
WORKSPACE="${PROJECT_DIRECTORY}/${SF_TARGET_NAME}.xcodeproj"
echo "============================= BUILDING ${WORKSPACE} OTHER ${SF_OTHER_PLATFORM} ============================"
# Build the other platform.
xcodebuild -project "${WORKSPACE}" -scheme "framework" -sdk ${SF_OTHER_PLATFORM}${SF_SDK_VERSION} BUILD_DIR="${BUILD_DIR}" OBJROOT="${OBJROOT}" BUILD_ROOT="${BUILD_ROOT}" SYMROOT="${SYMROOT}" $ACTION
